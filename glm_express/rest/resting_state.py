...
class RestingState(Build_RS):
    ...
    def plot_connectomes(
        ...
        if show_plot:
            ...
            # FIXME This is hacky but effectively suppresses output
            try:
    ...
    def extract_time_series(
        self,
        run: Union[str, int] = "ALL",
        method: str = "maps",
        atlas_to_use: str = None,
        labels_to_use: Optional[list] = None,
    ...
    def matrix_from_masker(
        ...
        run: Union[str, int] = "ALL",
        method: str = "maps",
        atlas_to_use: Optional[str] = None,
        labels_to_use: Optional[list] = None,
        standardize: bool = True,
    ...
    def _matrix_to_dataframe(
        self, incoming_matrix=None, labels=None, a_comp_cor=True, t_comp_cor=True
    ):
        """
        IN DEVELOPMENT
