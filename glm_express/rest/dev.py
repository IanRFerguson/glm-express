...
class DevelopmentalRS(RestingState):
      ...
      # -- Constructor
      def __init__(self, sub_id, task, bids_root, 
                   suppress, template_space):

            RestingState.__init__(self, task=task, bids_root=bids_root,
                                  suppress=suppress, template_space=template_space)


      # -- Maskers
      def _matrix_from_labels_masker(self, run="ALL", atlas_to_use=None, labels_to_use=None, standardize=True,
...
Confounds:\t\t{confound}
      ...
      def _matrix_from_maps_masker(self, run, atlas_to_use=None, labels_to_use=None, standardize=True,
                                  save_matrix_output=False, save_plots=False, show_plots=True, 
                                  return_array=True, verbose=True):
            """
